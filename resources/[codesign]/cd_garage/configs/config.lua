...
Config.VehicleKeys = {
    ...
    Hotwire = {
        ...
        ActionBar = {
            [1] = {seconds = 4, size = 30, chances = 3}, --Choose how many seperate action bars you will need to complete to hotwire a vehicle you do not have keys for.
            [2] = {seconds = 3, size = 20, chances = 2},
            [3] = {seconds = 3, size = 10, chances = 1}, --This is the 3rd action bar.
...
Config.JobVehicles = {
    ...
    Locations = {
        ...
        ['police'] = { --If you choose to add more tables here for more jobs, they must be the jobs name, not the label.
            --MISSION ROW PD
            [1] = {coords = vector3(441.53, -1014.15, 28.65), spawn_coords = vector4(444.17, -1021.27, 28.53, 90.41), distance = 10, garage_type = 'car', method = 'regular'}, --Mission Row PD (cars)
            [2] = {coords = vector3(-1096.26, -832.2, 37.7), spawn_coords = vector4(-1096.26, -832.2, 37.7, 34.85), distance = 5, garage_type = 'air', method = 'regular'}, --Mission Row PD (helipad)
            --SANDY PD
    ...
    RegularMethod = {
        ...
        ['police'] = {
            [1] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polbuff`},
            [2] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `nkcruiser`},
            [3] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `prevolter`},
            [4] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `bearcat`},
            [5] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `cara`},
            [6] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `nkballer7`},
            [7] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `nkdominator3`},
            [8] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `nkgauntlet4`},
            [9] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `nkscout`},
            [10] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `nktorrence`},
            [11] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `nkvstr`},
            [12] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `pbike`},
            [13] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polbullet2`},
            [14] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polchaser`},
            [15] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polcoquette4`},
            [16] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `policeb1`},
            [17] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `policeb2`},
            [18] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polvigero2`},
            [19] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `r1200rtp`},
            [20] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `fibsultan`},
            [21] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `apoliceu13`},
            [22] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `apoliceu10`},
            [23] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `apoliceu15`},
            [24] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `apoliceu9`},
            [25] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'air', model = `as350`},
            [26] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'boat', model = `predator`},
        },
        ['ambulance'] = {
            [1] = {job = 'ambulance', spawn_max = true, plate = 'EMS', job_grade = 0, garage_type = 'car', model = `erpambo`},
            [2] = {job = 'ambulance', spawn_max = true, plate = 'EMS', job_grade = 0, garage_type = 'air', model = `aw139`},
        },
    }
}
-- ██████╗  █████╗ ███╗   ██╗ ██████╗      ██████╗  █████╗ ██████╗  █████╗  ██████╗ ███████╗███████╗
...
Config.GangGarages = {
    ...
    Locations = {
        ...
        [1] = {gang = 'nolimit', garage_id = 'NoLimit', coords = vector3(493.47, -1330.26, 29.34), spawn_coords = vector4(493.50, -1319.57, 29.23, 310.98), distance = 15, garage_type = 'car'}, --GROVE STREET
        [2] = {gang = 'shoreline', garage_id = 'Shoreline', coords = vector3(-68.51, 355.9, 112.44), spawn_coords = vector4(-53.45, 348.44, 112.37, 153.38), distance = 10, garage_type = 'car'},
        [3] = {gang = 'triads', garage_id = 'Triads', coords = vector3(-684.44, -882.07, 24.5), spawn_coords = vector4(-682.18, -892.58, 24.5, 270.55), distance = 10, garage_type = 'car'},
...
if Config.InsideGarage.ENABLE then
    UIText =  L('open_garage_1').. L('open_garage_2').. L('notif_storevehicle')
else
    UIText =  L('open_garage_1')
end
...
Config.Locations = {
    ...
    },
    {
        ...
        Type = 'car',
        Dist = 10,
        x_1 = 757.94879, y_1 = -1412.761, z_1 = 26.527479,
        EventName1 = 'cd_garage:QuickChoose',
        EventName2 = 'cd_garage:EnterGarage',
        Name = UIText,
        x_2 = 757.94879, y_2 = -1412.761, z_2 = 26.527479,
        EnableBlip = true,
        JobRestricted = nil,
        ShellType = '10cargarage_shell',
    },
