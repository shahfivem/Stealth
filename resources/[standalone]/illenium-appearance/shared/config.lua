...
Config.Stores = {
    ...
    {
        type = "clothing",
        coords = vector4(461.59, -997.36, 31.13, 216.94),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false, -- false => uses the size + rotation to create the zone | true => uses points to create the zone
        ...
        --targetScenario = "" -- overrides the target scenario configure for the group
        points = {
            vec3(459.39999389648, -999.84997558594, 31.0),
            vec3(464.25, -999.90002441406, 31.0),
            vec3(464.29998779297, -995.5, 31.0),
            vec3(459.0, -995.5, 31.0),
        }
    },
    {
        type = "clothing",
