...
Config.Framework = { -- Just Enable one of them
    QBCore = true, -- If you use QB, remember to remove the ex_extended line in fxmanifest.lua
    ESX = false
}
...
Config.UseNewESX = false -- Ignore if using QB
...
Config.StartMission = {
    ...
    startcoords = vector4(-208.33, -1114.47, 22.87, 68.03), -- Coords where u can start Mission
    vehiclespawn = vector4(-215.74, -1120.18, 23.0, 163.07), -- Coords where the Vehicle will Spawn/where u also can complete the Mission
