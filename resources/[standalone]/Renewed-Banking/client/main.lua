...
function CreatePeds()
    ...
    for k = 1, #Config.peds do
        ...
        function pedPoint:onEnter()
            ...
            self.ped = CreatePed(0, self.model, self.coords.x, self.coords.y, self.coords.z - 1, self.heading, false,
                false)
        ...
        function pedPoint:onExit()
            exports.ox_target:removeLocalEntity(self.ped,
                self.advanced and 'renewed_banking_accountmng' or 'renewed_banking_openui')
