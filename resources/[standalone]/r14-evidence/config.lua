...
Config.UseFivemanage = false
Config.FivemanageAPIKey = "Cl4yISrRoelaxnyYKXhJhUK0PopmDLva"
-----------------------------------------------------------------------------------------------------------
--------------------------------------        Debug Config         ----------------------------------------
-----------------------------------------------------------------------------------------------------------
...
Config.AuthorizedJobs = {
    LEO = { -- this is for job checks which should only return true for police officers
        Jobs = {['police'] = true, ['offpolice'] = true, ['sasp'] = true, ['lspd'] = true, ['bcso'] = true, ['doc'] = true, ['lsco'] = true, ['comm'] = true},
        Types = {['police'] = true, ['leo'] = true, ['leo1'] = true},
    ...
    Frisk = { -- this is for configuring the frisk job check, you can enable it for all civlians, or specific jobs
        ...
        Jobs = {['police'] = true, ['fib'] = true, ['doc'] = true, ['bcso'] = true, ['lsco'] = true, ['lspd'] = true, ['sasp'] = true, ['ambulance'] = true}, -- you can add a rank table here to give the option to only specific job ranks, like bounchers
        Types = {['police'] = true, ['leo'] = true, ['leo1'] = true},
        Check = function(source)
            local PlyData = nil
            if source then PlyData = Config.Functions.PlayerDataServer(source) else PlyData = Config.Functions.PlayerDataClient() end
...
Config.StatusList = {
    ...
    ['gunpowder'] = 'Red Gunpowder Residue',
