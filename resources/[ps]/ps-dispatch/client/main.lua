...
local function addBlip(data, blipData)
    ...
    if not alertsMuted then
        if type(blipData.sound) == 'table' then
            if #blipData.sound == 2 then
                PlaySound(-1, blipData.sound[1], blipData.sound[2], 0, 0, 1)
            elseif #blipData.sound == 3 then
                TriggerEvent(blipData.sound[1], blipData.sound[2], blipData.sound[3])
            elseif #blipData.sound == 4 then
                TriggerServerEvent(blipData.sound[1], blipData.sound[2], blipData.sound[3], blipData.sound[4])
            end
        else
