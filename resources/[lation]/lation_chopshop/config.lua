...
Config.Items = {
    ...
    lockpick = {
        item = 'advancedlockpick', -- Item name in inventory resource
...
Config.Shops = {
    ...
    swapShop = {
        ...
        items = {
            ...
            -- min: minimum amount the player must purchase at once
            -- max: maximum amount the player can purchase at once
            [1] = { item = 'loosenotes', price = 1, label = 'Loose Notes', icon = 'fas fa-sack-dollar', iconColor = '', quantity = 1, min = 1, max = 5000 },
            [2] = { item = 'plastic', price = 5, label = 'Plastic', icon = 'fas fa-sheet-plastic', iconColor = '', quantity = 5, min = 15, max = 50 },
            [3] = { item = 'iron', price = 10, label = 'Iron', icon = 'fas fa-layer-group', quantity = 5, iconColor = '', min = 1, max = 50 },
            [4] = { item = 'aluminum', price = 15, label = 'Aluminum', icon = 'fas fa-cubes-stacked', iconColor = '', quantity = 5, min = 1, max = 50 },
            [5] = { item = 'usb', price = 5000, label = 'Illegal USB', icon = 'fab fa-usb', min = 1, iconColor = '', quantity = 5, max = 1 },
            -- See example below on how to add more items here:
...
Config.ClientRequests = {
    ...
    armourAmount = 75, -- If givePedArmour = true, how much? (ranges from 0 to 100)
    sellAccount = 'markedbills', -- When selling a vehicle, how does player receive payment? (bank, cash, markedbills, etc)
    tracking = { -- Various options for the tracking blip settings
        ...
        blip = { -- Blip settings
            shortRange = true, -- True to display the blip on minimap only if nearby and false to display the blip from any distance
