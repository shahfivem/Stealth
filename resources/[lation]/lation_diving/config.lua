...
-- As well as the "distance" variable from a location the TextUI will display
...
Config.Boat = {
    ...
    Teleport = true, -- Teleport player into boat when rented?
...
-- A random number will be selected between the min & max and reward that many items. For example, if min = 1 and max = 2
-- Then when a player opens a crate it is possible to get 1 item or 2 items, each crate randomly selects how many to give
-- Based on the min/max. If you want it the same each time, set the min & max to the same number
Config.RewardsCount = { min = 1, max = 2 }
...
Config.CrateRewards = {
    ...
    ['blueprint_heavypistol'] = { chance = 25, quantity = {min = 1, max = 1} },
    ['burger'] = { chance = 50, quantity = {min = 1, max = 3} },
    ['blueprint_paper'] = { chance = 40, quantity = {min = 1, max = 2} },
    ['money'] = { chance = 30, quantity = {min = 500, max = 1000} },
    ['advancedlockpick'] = { chance = 20, quantity = {min = 1, max = 2} },
    ['ls_access_card'] = { chance = 25, quantity = {min = 1, max = 1} },
