...
-- Empty function that is triggered upon gear equipped
ScubaGearEquipped = function()

end

-- Empty function that is triggered upon gear removal/un-equipped
ScubaGearRemoved = function()
