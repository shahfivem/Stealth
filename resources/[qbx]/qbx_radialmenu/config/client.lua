local bags = { [40] = true, [41] = true, [44] = true, [45] = true }
    -- Register the confirmation menu
    lib.registerContext({
        id = 'emergencyConfirmation',
        title = 'Are you sure?',
        canClose = false,  -- Prevent closing the menu without making a selection
        options = {
            {
                title = 'Yes',
                icon = 'check',
                onSelect = function()
                    -- Proceed with dispatching the emergency alert for police
                    exports['ps-dispatch']:CustomAlert({
                        message = 'Officer In Distress - 13A',
                        dispatchCode = '13A',
                        code = '10-13A',
                        icon = 'fas fa-bell',
                        priority = 1,
        ...
        options = {
            {
                ...
                icon = 'check',
                onSelect = function()
                    -- Proceed with dispatching the emergency alert for EMS
                    exports['ps-dispatch']:CustomAlert({
                        message = 'EMS In Distress - 51A',
                        dispatchCode = '51A',
                        code = '10-51A',
                        icon = 'fas fa-bell',
                        priority = 1,
    ...
    jobItems = {
        police = {
            {
                ...
                onSelect = function()
                    -- Show the confirmation menu before dispatching the emergency alert
                    lib.showContext('emergencyConfirmation')
                end
            },            
            {
                id = 'radio',
                ...
                items = {
                    {
                        ...
                        onSelect = function()
                            ...
                            exports.erp_progressbar:taskBar({
                                text = 'Checking Player Status',
                                length = 5000,
        ...
        ambulance = {
            ...
            
            {
                ...
                onSelect = function()
                    -- Show the confirmation menu before dispatching the emergency alert
                    lib.showContext('emergencyConfirmationems')
                end
            },  
            {
                id = 'escort',
