...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		...
		{ 15.0, "Screaming" }, -- Shout speech distance in gta distance units
		{ 45.0, "Public Announcement" } -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		...
		{ 25.0, "Screaming" }, -- Shout speech distance in gta distance units
		{ 75.0, "Public Announcement" } -- Shout speech distance in gta distance units
	}
end
