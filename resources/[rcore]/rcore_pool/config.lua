Config = {
    ...
    Text = {
        BACK = "Back",
        HIT = "Hit",
        BALL_IN_HAND = "Take the ball in hand",
        ...
        HINT_SETUP = 'Set up the game',
        HINT_TAKE_CUE = 'Take the cue.',
        HINT_RETURN_CUE = 'Return the cue.',
        HINT_HINT_TAKE_CUE = 'You need to take the cue to play pool.',
        HINT_PLAY = 'Play',
        ...
        BALL_POCKETED = '%s You pocketed the ball',
        BALL_IN_HAND_NOTIFY = 'You have taken the pool ball in hand',
        BALL_LABELS = {
            [-1] = 'Cue',
            [1] = '~y~Solid 1~s~',
            [2] = '~b~Solid 2~s~',
