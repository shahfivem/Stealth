...
AddEventHandler('rcore_pool:openMenu', function()
    ...
    -- Register the pool game menu with options
    lib.registerContext({
        id = 'pool_game_menu',
        title = 'Choose Pool Game',
        canClose = true,
        options = {
            {
                title = '8-Ball',
                description = 'Eight-ball is a pool billiards game played on a table with six pockets, cue sticks, and sixteen balls.',
                icon = 'circle',
                iconColor = 'blue',
                arrow = false,
                onSelect = function()
            ...
            {
                title = 'Straight Pool',
                description = 'Straight pool, also known as 14.1 continuous, is a cue sport where players attempt to pot as many balls as possible.',
                icon = 'circle',
                iconColor = 'teal',
                arrow = false,
                onSelect = function()
    ...
    -- Display the menu
    lib.showContext('pool_game_menu')
end)
