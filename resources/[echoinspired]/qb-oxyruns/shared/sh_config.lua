...
Config.StartLocation = vector4(-1078.65, -2138.23, 13.4, 132.72) -- Start location for oxy run
...
Config.CallCopsChance = 65 -- %Chance to alert police

Config.LaunderChance = 100 -- %Chance to launder money
Config.LaunderItems = {
    { name = 'markedbills', price = 1800 },
    { name = 'loosenotes', price = 62.50 },
    { name = 'stackofcash', price = 675 },
    { name = 'inkedmoneybag', price = 2200 },
    { name = 'rollsofcash', price = 487.5 },
}
...
Config.RareLootItem = 'redkeycard' -- Rare loot item
