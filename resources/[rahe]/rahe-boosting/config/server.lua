svConfig = {
    ...
    storeItems = {
        ...
        ['harness'] = {
            ...
            isSoldOut = false,
            title = "Harness",
            description = "Temporary, but cheaper, variant harness.",
...
supportedVehicles = {
    ...
    { name = "Shlagen STR", model = "schlagenstr", class = "S" },
    { name = "Cypher GST", model = "gstcyp1", class = "S" },
    { name = "Reaper GPR", model = "reagpr", class = "S" },
